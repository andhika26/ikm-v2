...
<head>
    ...
    <title>Tentang Kami - e-KLiK || Survei Kepuasan Masyarakat Lingkup Kepelabuhanan PPP Bulu</title>
    <!-- google-fonts -->
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                     <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="tentang-kami">Tentang <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="inner-banner">
        <div class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold">Tentang Kami</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="./">Beranda</a></li>
                    <li class="active"><i class="fas fa-angle-right mx-2"></i>Tentang Kami</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="w3l-bottom-grids-6 py-5">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-5" style="max-width:100%;">
                <p class="text-uppercase">Kata Pengantar</p>
                <h3 class="title-style">Mengapa <span>Perlu </span> Survei Kepuasan Masyarakat?</h3>
            </div>
            ...
            <p align="justify">
Pemerintah sangat membutuhkan informasi dari unit pelayanan instansi pemerintah secara rutin, dengan harapan mampu memberikan gambaran mengenai kualitas pelayanan di instansi pemerintah kepada masyarakat.
<br><b>Dasar Pelaksanaan Survey ini : </b><br>
<ol>
    <li><b>Peraturan Menteri Pendayagunaan Aparatur Negeri dan Reformasi Birokrasi Nomor 14 Tahun 2017 tentang Pedoman Penyusunan Survei Kepuasan Masyarakat Terhadap Penyelenggara Pelayanan Publik</b></li>
    <li><b>Peraturan Gubernur Jawa Timur Nomor 26 Tahun 2021 Tentang Pedoman Pelaksanaan Survei Kepuasan Masyarakat pada Unit Penyelenggara Pelayanan Publik</b></li>
    </ol>

Survei ini menyatakan pendapat masyarakat mengenai pengalaman dalam memperoleh pelayanan instansi pemerintah, dalam hal ini UPT Pelabuhan Perikanan Pantai (PPP) Bulu untuk kepentingan tersebut kami menyampaikan kuesioner untuk diisi sesuai apa yang dirasakan dan dialami selama mendapatkan pelayanan . tidak ada jawaban yang benar atau salah sehingga apapun jawaban anda murni menjadi masukkan penilaian kami.
</p></div>
        </div>
    </section>
    <!-- //banner bottom section -->
