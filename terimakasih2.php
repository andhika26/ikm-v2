...
<head>
    ...
    <title>Terima Kasih - e-KLiK || Survei Kepuasan Masyarakat Lingkup Kepelabuhanan PPP Bulu</title>
     <meta http-equiv="refresh" content="15;url=https://pppbulu.dkp.jatimprov.go.id/ikm/first" />
    <!-- google-fonts -->
...
<body>
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="kuisioner.php">Isi Kuisioner</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="kontakkami.php">Kontak Kami <span class="sr-only">(current)</span></a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="inner-banner">
        <div class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold">Terima Kasih</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="#">e-KLiK - Survei Kuisioner Kepuasan Masyarakat</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="w3l-contact py-5" id="contact">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-5" style="max-width:500px;">
                <p class="text-uppercase">Kuisioner Telah Diterima</p>
                <h3 class="title-style"><span>UPT Pelabuhan Perikanan Pantai Bulu</span></h3>
            </div>
            <div class="mx-auto" style="max-width:1000px">
                <div class="row contact-block">
                    <div class="col-md-12 contact-right">
                        <img src="assets/images/terimakasih.gif" alt="" class="img-fluid">
                    </div>
                    
                </div>
            </div>
            <div class="below-section text-center pt-lg-4 mt-5">
                <p><center>Halaman akan dialikan selama 15 Detik</center></a>
                </p>
            </div>
        </div>
    </section>
    ...
    <footer class="w3l-footer-16 py-5">
        <div class="container pt-md-4">
            ...
            <div class="below-section text-center pt-lg-4 mt-5">
                <p class="copy-text">&copy; <?php echo $tahun; ?> e-KLiK. All rights reserved <b>UPT Pelabuhan Perikanan Pantai Bulu</b></a>
                </p>
            </div>
        </div>
    </footer>
